...
def bouw(p):
    ...
    p.tekst(
        ...
        '<ol>'
        '<li><b>Open de prompt optimizer:</b> '
        '<a href="https://chatgpt.com/g/g-67dc7d4aa4348191b8dc26bacd5396b7-prompt-optimizer" '
        'target="_blank" rel="noopener">chatgpt.com/g/…/prompt-optimizer</a> (opent in '
        'een nieuw tabblad). Klik hem daarna aan in je zijbalk en kies '
        '<i>Vastzetten</i>, zodat je hem elke keer terugvindt zonder te zoeken.</li>'
