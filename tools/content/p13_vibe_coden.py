...
def bouw(p):
    ...
    p.aandacht(
        ...
        'hoort.</li>'
        '<li><b>Zelfgebouwde inlogsystemen.</b> Authenticatie zelf bouwen gaat mis, '
        'ook voor ervaren programmeurs — wachtwoorden opslaan, sessies beheren, '
        'resetmails: elk onderdeel is een kans op een lek. Moet er ingelogd worden, '
        'gebruik dan <b>Google-inloggen</b> via Firebase. Dat is één instelling in '
        'plaats van honderden regels code, en je slaat zelf geen wachtwoorden op. '
        'Hoofdstuk 14 laat zien hoe.</li>'
